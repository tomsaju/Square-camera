...
public class CameraFragment extends Fragment
    ...
    private String FRONT_CAMERA = "1";
    private String REAR_CAMERA = "0";
    ...
    private void checkCameraAvailability() {
        ...
        try {
            String[] availableCameraList = manager.getCameraIdList();
            List<String> list = Arrays.asList(availableCameraList);

            if(list.contains(FRONT_CAMERA)){
               mCameraId = FRONT_CAMERA;
            }else{
                mCameraId = REAR_CAMERA;
            }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Toast.makeText(activity, "Invalid Camera Id", Toast.LENGTH_SHORT).show();
            mCameraId = REAR_CAMERA;
            if (mTextureView.isAvailable()) {
                openCamera(mTextureView.getWidth(), mTextureView.getHeight());
            } else {
...
*/
    ...
    public void switchCamera() {
        if (mCameraId.equals(FRONT_CAMERA)) {
            ...
            closeCamera();
            reopenCamera();
        } else if (mCameraId.equals(REAR_CAMERA)) {
            mCameraId = FRONT_CAMERA;
            closeCamera();
            reopenCamera();
        }
